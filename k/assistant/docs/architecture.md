...
- Использовать быстрые карточки на главной: «Мой журнал» и «Мои задачи» переходят в разделы, карточки «Диалоги», «Инструменты», «PARA», «Финансы», «Сервисы», «Библиотека» запускают только глобальный glitch-эффект без навигации.
