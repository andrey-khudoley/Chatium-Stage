      ...
      <head>
        ...
        <style>{`
          ...
          body::after {
            ...
            opacity: 0;
            animation:
              scanline-fade-in 0.6s ease-out 0.3s forwards,
              scanline-flicker 8s linear 0.9s infinite;
          }
          ...
          body::before {
            ...
            opacity: 0;
            animation: bezel-fade-in 0.8s ease-out 0.5s forwards;
          }
          ...
          .app-layout {
            ...
            filter: blur(0.5px);
            animation: crt-power-on 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94) 0.2s forwards;
          }

          @keyframes crt-power-on {
            0% { opacity: 0; transform: scale(0.98); filter: blur(0.5px); }
            30% { opacity: 0.5; transform: scale(0.99); filter: blur(0.3px); }
            60% { opacity: 0.85; transform: scale(1.0); filter: blur(0.1px); }
