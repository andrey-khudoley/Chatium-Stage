...
<template>
  <div class="app-layout bg-[var(--color-bg)] text-[var(--color-text)] flex flex-col min-h-screen">
    <GlobalGlitch />
    <!-- Header -->
    <Header v-if="bootLoaderDone" :projectTitle="props.projectTitle" pageName="Вход" :indexUrl="props.indexUrl" :profileUrl="props.profileUrl" :loginUrl="props.loginUrl" :isAuthenticated="props.isAuthenticated" :isAdmin="props.isAdmin" :adminUrl="props.adminUrl" />
