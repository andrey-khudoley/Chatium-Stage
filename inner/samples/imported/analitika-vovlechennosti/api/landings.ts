...
// @shared-route
export const apiCreateLandingRoute = app.body(s => ({
  path: s.string(),
  title: s.string()
...
// @shared-route
export const apiToggleLandingRoute = app.body(s => ({
  id: s.string(),
  isActive: s.boolean()
...
// @shared-route
export const apiUpdateLandingTitleRoute = app.body(s => ({
  id: s.string(),
  title: s.string()
...
// @shared-route
export const apiDeleteLandingRoute = app.body(s => ({
  id: s.string()
