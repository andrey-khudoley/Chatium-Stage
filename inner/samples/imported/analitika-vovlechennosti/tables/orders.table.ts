...
export const TAnalitikaLendovTAnalitikaLendovOrdersOrdBiO = Heap.Table(
  ...
  {
    lend: Heap.Optional(
      Heap.String({ customMeta: { title: 'Лендинг (путь без слеша)' }, searchable: { langs: ['ru', 'en'] } }),
    ),
    date: Heap.Optional(
      Heap.String({ customMeta: { title: 'Дата заказа (для совместимости)' }, searchable: { langs: ['ru', 'en'] } }),
    ),
    status: Heap.Optional(Heap.String({ customMeta: { title: 'Статус заказа' }, searchable: { langs: ['ru', 'en'] } })),
    ...
    utm_term: Heap.Optional(Heap.String({ customMeta: { title: 'UTM Term' }, searchable: { langs: ['ru', 'en'] } })),
...
export type TAnalitikaLendovTAnalitikaLendovOrdersOrdBiORow = typeof TAnalitikaLendovTAnalitikaLendovOrdersOrdBiO.T
