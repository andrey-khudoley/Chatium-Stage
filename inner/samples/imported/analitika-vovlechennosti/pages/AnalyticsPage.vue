  ...
  <div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="flex flex-col gap-2 flex-1">
            ...
            <div class="flex items-center gap-4">
              ...
              >
                ...
                <option v-for="landing in availableLandings" :key="landing.path" :value="landing.path">
          ...
          <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-start justify-between gap-3">
              <div class="flex-1 min-w-0">
                ...
                <p class="text-2xl font-bold text-gray-900 leading-none">{{ engagementStats.length }}</p>
              </div>
          ...
          <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-start justify-between gap-3">
              <div class="flex-1 min-w-0">
                ...
                <p class="text-2xl font-bold text-gray-900 leading-none">{{ (getTotalVisits() || 0).toLocaleString() }}</p>
              </div>
          ...
          <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-start justify-between gap-3">
              <div class="flex-1 min-w-0">
                ...
                <p class="text-2xl font-bold text-gray-900 leading-none">{{ (getTotalSessions() || 0).toLocaleString() }}</p>
              </div>
          ...
          <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-start justify-between gap-3">
              <div class="flex-1 min-w-0">
                ...
                <p class="text-2xl font-bold text-gray-900 leading-none">{{ getTotalRegistrations() }}</p>
          ...
          <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-start justify-between gap-3">
              <div class="flex-1 min-w-0">
                ...
                <p class="text-2xl font-bold text-gray-900 leading-none">{{ getTotalPayments() }}</p>
          ...
          <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-start justify-between gap-3">
              <div class="flex-1 min-w-0">
                ...
                <p class="text-2xl font-bold text-gray-900 leading-none">{{ getTotalPaymentsAmount().toLocaleString() }} ₽</p>
              </div>
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <template v-for="landing in engagementStats" :key="landing.path + '_conv'">
                  <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <span class="px-3 py-1 rounded-full text-sm font-medium" :class="getConversionClass(landing.conversion_rate)">
        ...
        <div v-else-if="sessionsData.length > 0" class="p-6">
          ...
          <div class="relative" style="height: 300px">
            <svg width="100%" height="100%" viewBox="0 0 1000 300" preserveAspectRatio="none">
              ...
              <!-- Y-axis labels -->
              <text v-for="i in 6" :key="'label-y-' + i"
                x="40" :y="250 - (i - 1) * 40"
                text-anchor="end"
                font-size="12"
                fill="#6b7280"
          ...
          <div class="mt-4 flex justify-between text-xs text-gray-600 px-12">
            ...
            <span v-if="sessionsData.length > 1">{{ sessionsData[Math.floor(sessionsData.length / 2)]?.date }}</span>
            ...
            <tbody class="bg-white">
              ...
              <template v-for="(yearData, yearName) in dateHierarchy" :key="yearName">
                ...
                >
                  <td class="px-6 py-3">
                    <div class="flex items-center gap-2">
                      <i class="fas text-gray-400" :class="expandedDateNodes[yearName] ? 'fa-chevron-down' : 'fa-chevron-right'"></i>
                      <i class="fas fa-calendar text-blue-600"></i>
                      <span class="font-semibold text-gray-900">{{ yearData.label }}</span>
                    </div>
                  </td>
                  <td class="px-6 py-3 text-sm font-semibold text-gray-900">{{ yearData.visits_count }}</td>
                  <td class="px-6 py-3 text-sm font-semibold text-gray-900">{{ yearData.sessions_count }}</td>
                  <td class="px-6 py-3">
                    <span class="px-2 py-1 rounded text-xs font-medium bg-blue-100 text-blue-800">
                      {{ yearData.avg_duration_formatted || '0 сек' }}
                    </span>
                  </td>
                  <td class="px-6 py-3 text-sm text-gray-600">{{ yearData.min_duration_formatted || '0 сек' }}</td>
                  <td class="px-6 py-3 text-sm text-gray-600">{{ yearData.max_duration_formatted || '0 сек' }}</td>
                  <td class="px-6 py-3">
                  ...
                  <td class="px-6 py-3">
                    <span class="px-2 py-1 rounded text-xs font-medium" :class="getConversionClass(yearData.conversion_rate)">
                ...
                <template v-if="expandedDateNodes[yearName]">
                  <template v-for="(monthData, monthKey) in yearData.children" :key="yearName + '_' + monthKey">
                    <!-- Month row -->
                    <tr 
                    ...
                    >
                      <td class="px-6 py-2">
                        <div class="flex items-center gap-2" style="padding-left: 2rem">
                          <i class="fas text-gray-400" :class="expandedDateNodes[yearName + '_' + monthKey] ? 'fa-chevron-down' : 'fa-chevron-right'"></i>
                      ...
                      <td class="px-6 py-2 text-sm text-gray-900">{{ monthData.sessions_count }}</td>
                      <td class="px-6 py-2">
                        <span class="px-2 py-1 rounded text-xs font-medium bg-green-100 text-green-800">
                          {{ monthData.avg_duration_formatted || '0 сек' }}
                        </span>
                      </td>
                      <td class="px-6 py-2 text-sm text-gray-600">{{ monthData.min_duration_formatted || '0 сек' }}</td>
                      <td class="px-6 py-2 text-sm text-gray-600">{{ monthData.max_duration_formatted || '0 сек' }}</td>
                      <td class="px-6 py-2 text-sm text-gray-900">{{ monthData.conversions_count || 0 }}</td>
                      <td class="px-6 py-2">
                        <span class="px-2 py-1 rounded text-xs font-medium" :class="getConversionClass(monthData.conversion_rate)">
                          {{ monthData.conversion_rate ? monthData.conversion_rate.toFixed(2) : '0.00' }}%
                        </span>
                      </td>
                    </tr>
                      ...
                      >
                        ...
                        <td class="px-6 py-2">
                          <div class="flex items-center gap-2" style="padding-left: 4rem">
                            ...
                            <span class="text-gray-600">{{ monthData.children[dayKey].label }}</span>
                          </div>
                        </td>
                        <td class="px-6 py-2 text-sm text-gray-900">{{ monthData.children[dayKey].visits_count }}</td>
                        <td class="px-6 py-2 text-sm text-gray-900">{{ monthData.children[dayKey].sessions_count }}</td>
                        <td class="px-6 py-2">
                        ...
                        <td class="px-6 py-2 text-sm text-gray-600">{{ monthData.children[dayKey].min_duration_formatted }}</td>
                        <td class="px-6 py-2 text-sm text-gray-600">{{ monthData.children[dayKey].max_duration_formatted }}</td>
                        <td class="px-6 py-2 text-sm text-gray-900">{{ monthData.children[dayKey].conversions_count || 0 }}</td>
                        <td class="px-6 py-2">
                          <span class="px-2 py-1 rounded text-xs font-medium" :class="getConversionClass(monthData.children[dayKey].conversion_rate)">
                            {{ monthData.children[dayKey].conversion_rate ? monthData.children[dayKey].conversion_rate.toFixed(2) : '0.00' }}%
                          </span>
                        </td>
                        </template>
                      </tr>
            ...
            <tbody class="bg-white">
              <template v-for="landing in utmStats" :key="landing.path">
                ...
                <tr class="border-b border-gray-200 hover:bg-blue-50 cursor-pointer" @click="toggleUtmNode(landing.path)">
                  ...
                  <td class="px-6 py-3">
                    <span class="px-2 py-1 rounded text-xs font-medium" :class="getConversionClass(getLandingConversionRate(landing))">
                ...
                <template v-if="expandedUtmNodes[landing.path]">
                  <template v-for="(sourceData, sourceName) in landing.hierarchy" :key="landing.path + '_' + sourceName">
                    ...
                    >
                      ...
                      <td class="px-6 py-2 text-sm text-gray-900">{{ sourceData.conversions_count || 0 }}</td>
                      <td class="px-6 py-2">
                        <span class="px-2 py-1 rounded text-xs font-medium" :class="getConversionClass(sourceData.conversion_rate)">
                          {{ sourceData.conversion_rate ? sourceData.conversion_rate.toFixed(2) : '0.00' }}%
                        </span>
                      </td>
                    </tr>
                    ...
                    <template v-if="expandedUtmNodes[landing.path + '_' + sourceName]">
                      <template v-for="(mediumData, mediumName) in sourceData.children" :key="landing.path + '_' + sourceName + '_' + mediumName">
                        ...
                        >
                          ...
                          <td class="px-6 py-2 text-sm text-gray-900">{{ mediumData.conversions_count || 0 }}</td>
                          <td class="px-6 py-2">
                            <span class="px-2 py-1 rounded text-xs font-medium" :class="getConversionClass(mediumData.conversion_rate)">
                              {{ mediumData.conversion_rate ? mediumData.conversion_rate.toFixed(2) : '0.00' }}%
                            </span>
                          </td>
                        </tr>
                        ...
                        <template v-if="expandedUtmNodes[landing.path + '_' + sourceName + '_' + mediumName]">
                          <template v-for="(campaignData, campaignName) in mediumData.children" :key="landing.path + '_' + sourceName + '_' + mediumName + '_' + campaignName">
                            ...
                            >
                              ...
                              <td class="px-6 py-2 text-sm text-gray-900">{{ campaignData.conversions_count || 0 }}</td>
                              <td class="px-6 py-2">
                                <span class="px-2 py-1 rounded text-xs font-medium" :class="getConversionClass(campaignData.conversion_rate)">
                                  {{ campaignData.conversion_rate ? campaignData.conversion_rate.toFixed(2) : '0.00' }}%
                                </span>
                              </td>
                            </tr>
                            ...
                            <template v-if="expandedUtmNodes[landing.path + '_' + sourceName + '_' + mediumName + '_' + campaignName]">
                              <template v-for="(termData, termName) in campaignData.children" :key="landing.path + '_' + sourceName + '_' + mediumName + '_' + campaignName + '_' + termName">
                                ...
                                >
                                  ...
                                  <td class="px-6 py-2 text-sm text-gray-900">{{ termData.conversions_count || 0 }}</td>
                                  <td class="px-6 py-2">
                                    <span class="px-2 py-1 rounded text-xs font-medium" :class="getConversionClass(termData.conversion_rate)">
                                      {{ termData.conversion_rate ? termData.conversion_rate.toFixed(2) : '0.00' }}%
                                    </span>
                                  </td>
                                </tr>
                                ...
                                <template v-if="expandedUtmNodes[landing.path + '_' + sourceName + '_' + mediumName + '_' + campaignName + '_' + termName]">
                                  ...
                                  >
                                    ...
                                    <td class="px-6 py-2 text-sm text-gray-900">{{ contentData.conversions_count || 0 }}</td>
                                    <td class="px-6 py-2">
                                      <span class="px-2 py-1 rounded text-xs font-medium" :class="getConversionClass(contentData.conversion_rate)">
                                        {{ contentData.conversion_rate ? contentData.conversion_rate.toFixed(2) : '0.00' }}%
                                      </span>
                                    </td>
                                  </tr>
                                </template>
      ...
      <div v-if="!loadingEngagement" class="mt-8 bg-white rounded-lg shadow overflow-hidden">
        ...
        <div v-else-if="demographicsData.regions.length > 0 || demographicsData.cities.length > 0" class="p-6">
              ...
              <div class="flex flex-col items-center">
                <svg width="300" height="300" viewBox="0 0 300 300">
                  <g transform="translate(150, 150)">
                    ...
                    >
                      <title>{{ decodeRegionName(sector.name) }}: {{ sector.count }} ({{ sector.percentage }}%)</title>
                    </path>
                  </g>
                </svg>
                ...
                <svg width="300" height="300" viewBox="0 0 300 300">
                  <g transform="translate(150, 150)">
                    <path 
                      ...
                      class="hover:opacity-80 cursor-pointer"
                    >
                      <title>{{ decodeCityName(sector.name) }}: {{ sector.count }} ({{ sector.percentage }}%)</title>
                    </path>
                  </g>
                </svg>
      ...
      <div v-if="!loadingEngagement" class="mt-8 bg-white rounded-lg shadow overflow-hidden">
        ...
        <div v-else-if="devicesData.deviceTypes.length > 0 || devicesData.deviceBrands.length > 0" class="p-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <svg width="300" height="300" viewBox="0 0 300 300">
                  <g transform="translate(150, 150)">
                    <path 
                      ...
                      class="hover:opacity-80 cursor-pointer"
                    >
                      <title>{{ decodeDeviceTypeName(sector.name) }}: {{ sector.count }} ({{ sector.percentage }}%)</title>
                    </path>
                  </g>
                </svg>
                ...
                <svg width="300" height="300" viewBox="0 0 300 300">
                  <g transform="translate(150, 150)">
                    <path 
                      ...
                      class="hover:opacity-80 cursor-pointer"
                    >
                      <title>{{ decodeDeviceBrandName(sector.name) }}: {{ sector.count }} ({{ sector.percentage }}%)</title>
                    </path>
                  </g>
                </svg>
          ...
          <div class="bg-blue-50 rounded-lg p-4 mb-6">
            ...
            <div class="space-y-3">
              ...
              <div class="flex gap-3">
                <div class="flex-1">
                  ...
                  <div v-if="pathInputMode === 'select'">
                    <div v-if="loadingPaths" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-gray-500">
              ...
              <div class="flex items-start gap-2 text-sm text-gray-600">
                ...
                <p>{{ pathInputMode === 'select' ? 'Выберите лендинг из списка доступных путей' : 'Введите полный путь к лендингу (начинается с /). Поддерживаются пути с тильдой (~) и вложенные директории' }}. Название заполнится автоматически.</p>
              </div>
...
import { apiGetEngagementStatsRoute, apiGetScrollHeatmapRoute, apiGetUtmStatsRoute, apiGetDateStatsRoute, apiGetSessionsByDayRoute, apiGetDemographicsRoute, apiGetDevicesRoute } from '../api/analytics'
import { apiGetLandingsRoute, apiCreateLandingRoute, apiToggleLandingRoute, apiDeleteLandingRoute, apiGetAvailablePathsRoute, apiUpdateLandingTitleRoute } from '../api/landings'
