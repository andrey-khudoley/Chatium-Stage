...
export const cards: Card[] = [
  {
    ...
    description: 'Сегодня звезды благоволят мастерам, которые ценят каждую минуту. Скорость работы определяет твой доход.',
    insight: 'Мастера, которые работают быстро и качественно, зарабатывают в 3-5 раз больше. Научись оптимизировать каждое движение.',
    icon: '⚡',
    color: '#FFD700',
  ...
  },
  {
    ...
    insight: 'Клиенты готовы платить за мастерство. Узнай, как правильно формировать цену и перестать работать за копейки.',
    icon: '💎',
    color: '#9333EA',
  ...
  },
  {
    ...
    description: 'Магия клиентского потока открывается тем, кто знает секреты притяжения идеальных клиентов.',
    insight: 'Научись работать только с любимыми клиентами и отсекать токсичных. Запись на месяц вперед — это реально.',
    icon: '✨',
    color: '#EC4899',
  ...
  },
  {
    ...
    insight: 'Узнай, как работать 5 часов в день и зарабатывать как за 12. Система энергоэффективной работы.',
    icon: '🔥',
    color: '#EF4444',
  ...
  },
  {
    ...
    insight: 'Секретные техники, которые превращают обычного мастера в ТОП-специалиста с очередью из клиентов.',
    icon: '👑',
    color: '#3B82F6',
  ...
  },
  {
    ...
    insight: 'Построй систему, которая позволит работать когда хочешь и с кем хочешь. Без жертв и перегрузок.',
    icon: '🦋',
    color: '#06B6D4',
  ...
  },
  {
    ...
    insight: 'Как выйти на стабильный доход от 200к в месяц и перестать переживать о деньгах. Конкретная система.',
    icon: '💰',
    color: '#10B981',
