...
export const TProjektChatChatSubscriptionsAHe = Heap.Table(
  't_projekt_chat_chat_subscriptions_2Xu',
  {
    ...
    renewalPlanId: Heap.Optional(
      Heap.RefLink('t_projekt_chat_chat_subscription_plans_9nM', { customMeta: { title: 'Тариф для продления' } }),
    ),
  ...
  { customMeta: { title: 'chat-subscriptions.table.ts', description: '' } },
)

export default TProjektChatChatSubscriptionsAHe

export type TProjektChatChatSubscriptionsAHeRow = typeof TProjektChatChatSubscriptionsAHe.T
export type TProjektChatChatSubscriptionsAHeRowJson = typeof TProjektChatChatSubscriptionsAHe.JsonT
