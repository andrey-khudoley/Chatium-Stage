...
export const TImageVideoGeneratorGenerationsDzg = Heap.Table(
  't_imageVideoGenerator_generations_6yJ',
  {
    ...
    uploadedImageHash: Heap.Optional(Heap.String({ customMeta: { title: 'Загруженное изображение (хеш)' } })),
    generatedImageHash: Heap.Optional(Heap.String({ customMeta: { title: 'Сгенерированное изображение (хеш)' } })),
    generatedVideoHash: Heap.Optional(Heap.String({ customMeta: { title: 'Сгенерированное видео (хеш)' } })),
...
export type TImageVideoGeneratorGenerationsDzgRowJson = typeof TImageVideoGeneratorGenerationsDzg.JsonT
