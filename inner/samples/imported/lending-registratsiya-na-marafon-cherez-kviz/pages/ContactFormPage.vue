<template>
  <div class="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-pink-100 flex items-center justify-center px-4 py-8">
    <div class="w-full max-w-2xl">
      ...
      <div class="bg-white rounded-3xl shadow-2xl p-6 md:p-12">
        ...
        <!-- Форма GetCourse -->
        <iframe 
          src="https://emi-courses.ru/pl/lite/widget/widget?id=1511729" 
...
<script setup>
// Форма GetCourse загружается через iframe
</script>