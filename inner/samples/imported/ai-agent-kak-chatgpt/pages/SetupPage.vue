    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-2xl p-8">
      ...
      <div class="mb-8">
        ...
        <div v-if="!currentTransport" class="mt-3">
          <p class="text-gray-500 text-xs">Создайте транспорт, через который будет общение с агентом.</p>
        </div>
        <button
          v-else
          disabled
        ...
        <div v-if="currentTransport" class="mt-3">
          ...
          <p class="text-gray-500 text-xs">
            Перейдите в управление транспортом для настройки подключенных к нему агентов и других параметров работы
            системы.
          </p>
        </div>
      </div>
