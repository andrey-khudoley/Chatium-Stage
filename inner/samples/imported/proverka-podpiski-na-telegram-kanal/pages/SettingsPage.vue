          ...
          <form @submit.prevent="saveSettings" class="p-6 space-y-6">
            ...
            <div class="space-y-4 border-t pt-6">
              <h3 class="text-lg font-semibold text-gray-900 flex items-center">
                <i class="fas fa-comments mr-2 text-telegram"></i>
                Настройка сообщений
              </h3>
              ...
              <div class="space-y-2">
                <label class="text-sm font-medium text-gray-700">
                  Сообщение после успешной проверки
                </label>
                <textarea
                  v-model="config.messages.subscribed"
                  rows="3"
                  class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-telegram focus:border-telegram transition-colors"
                  required
                ></textarea>
              ...
              <!-- Сообщение при неуспешной проверке -->
              <div class="space-y-2">
                <label class="text-sm font-medium text-gray-700">
                  Сообщение если не подписан
                </label>
                <textarea
                  v-model="config.messages.notSubscribed"
                  rows="3"
                  class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-telegram focus:border-telegram transition-colors"
                  required
                ></textarea>
