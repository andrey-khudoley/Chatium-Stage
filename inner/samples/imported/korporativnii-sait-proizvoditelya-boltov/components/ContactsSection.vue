          ...
          <div class="space-y-6">
            <div class="flex items-start space-x-4">
              ...
              <div>
                ...
                <a href="tel:+74951234567" class="text-lg font-semibold text-gray-900 hover:text-primary transition">
                  +7 (495) 123-45-67
                </a>
              </div>
            </div>
            ...
            <div class="flex items-start space-x-4">
              ...
              <div>
                ...
                <a href="mailto:info@boltprom.ru" class="text-lg font-semibold text-gray-900 hover:text-primary transition">
                  info@boltprom.ru
                </a>
              </div>
            </div>
