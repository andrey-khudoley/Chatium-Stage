  ...
  <div class="min-h-screen gradient-bg py-4 px-4">
    <div class="max-w-3xl mx-auto">
      ...
      <div v-if="!showResult" class="text-center mb-4 animate-fade-in">
        <div class="inline-block bg-gradient-to-r from-yellow-400 via-orange-400 to-pink-400 px-5 py-1.5 rounded-full text-white text-xs font-semibold mb-3 shadow-lg animate-pulse-soft">
      ...
      <div v-if="!showResult" class="quiz-card p-6 md:p-8">
        ...
        <div class="mb-6">
          <div class="flex justify-between items-center mb-2">
            ...
            <span class="text-sm font-semibold text-primary">{{ Math.round((currentQuestion / questions.length) * 100) }}%</span>
          </div>
              ...
              >
                <div class="flex items-center">
                  <div class="w-6 h-6 rounded-full border-2 mr-4 flex items-center justify-center flex-shrink-0"
                       :class="answers[currentQuestion] === option ? 'border-primary bg-primary' : 'border-gray-300'">
                    <svg v-if="answers[currentQuestion] === option" class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div v-if="showResult" class="quiz-card p-8 md:p-12">
        <div class="text-center mb-8">
          ...
          <p class="text-lg text-gray-600 mb-6">
            Оставьте свои контакты, чтобы получить подарок
          </p>
        </div>
