...
export const TTemplatesWebappOpenedWebappOpenedSettingsVfU = Heap.Table(
  't_templates_webapp_opened_webapp_opened_settings_mpn',
  {
    ...
    onlyFirstVisit: Heap.Optional(Heap.Boolean({ customMeta: { title: 'Только первое посещение' } })),
...
export type TTemplatesWebappOpenedWebappOpenedSettingsVfURow = typeof TTemplatesWebappOpenedWebappOpenedSettingsVfU.T
