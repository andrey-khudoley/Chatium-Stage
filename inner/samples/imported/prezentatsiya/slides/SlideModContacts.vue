...
const demoUrl = 'https://chatium.ru/app/crm/v2/~/customer/QaS7JkkfGCz6a0pzvqH0000ru?search=%D0%93%D0%B0%D0%BB%D1%87%D0%B5%D0%BD%D0%BA%D0%BE%D0%B2'
...
.orb-1 { width: 500px; height: 500px; background: #06b6d4; top: -20%; right: -10%; }
.orb-2 { width: 400px; height: 400px; background: #8b5cf6; bottom: -15%; left: -5%; animation-delay: -6s; }
.grid-pattern {
  position: absolute; inset: 0;
...
.feature i { color: #06b6d4; font-size: 16px; }
...
.demo-btn {
  ...
  border: 1px solid rgba(6,182,212,0.4); border-radius: 14px;
  background: rgba(6,182,212,0.08);
  color: #06b6d4; font-family: var(--font-display); font-size: 18px; font-weight: 700;
...
.demo-btn:hover {
  ...
  box-shadow: 0 8px 30px rgba(6,182,212,0.25), 0 0 60px rgba(6,182,212,0.1);
}
...
@media (max-width: 640px) {
  ...
  .demo-container { height: 100%; border-radius: 0; }
