  ...
  <div class="slide">
    ...
    <div class="container">
      <h2 class="title">
        ...
        <span class="title-line gradient-text">операционная система</span>
        <span class="title-line">для бизнеса</span>
      </h2>

      <div class="subtitle">Три составляющие платформы</div>
...
/* Для блока без label добавим отступ */
