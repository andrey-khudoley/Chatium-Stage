  ...
  <div
    ...
    <div class="w-full max-w-sm mx-auto flex flex-col items-center">
      ...
      <div
        ...
        :style="{ height: `${REEL_CONTAINER_HEIGHT}px` }">
        <!-- Fading overlays -->
        <div
        ...
        <div class="w-full h-full overflow-hidden">
          <div
            ...
            <PrizeCard
              ...
              :is-selected="
                !isSpinning &&
                index === SCRAMBLE_ITEMS_COUNT + (winningPrizeIndex ?? -1)
              " />
          </div>
        </div>
      </div>
...
<script setup lang="ts">
  ...
  const winningPrize = computed(() => {
    return winningPrizeIndex.value !== null
      ? INITIAL_PRIZES[winningPrizeIndex.value]
      : null
  })
  ...
  const handleSpin = () => {
    ...
    setTimeout(() => {
      ...
      const newTranslationY =
        -(targetReelIndex * TOTAL_ITEM_HEIGHT) + offsetToCenter
