...
export const TMdxEditorDocumentsEYy = Heap.Table(
  't_mdxEditor_documents_zFY',
  {
    ...
    type: Heap.Optional(
      Heap.String({ customMeta: { title: 'Тип' }, searchable: { langs: ['ru', 'en'], embeddings: true } }),
    ),
    mdxCode: Heap.Optional(
      Heap.String({ customMeta: { title: 'MDX код' }, searchable: { langs: ['ru', 'en'], embeddings: true } }),
    ),
    ...
    icon: Heap.Optional(
      Heap.String({ customMeta: { title: 'Иконка' }, searchable: { langs: ['ru', 'en'], embeddings: true } }),
    ),
    ...
    isPublished: Heap.Optional(
      Heap.Boolean({ customMeta: { title: 'Опубликовано' }, searchable: { langs: ['ru', 'en'], embeddings: true } }),
    ),
  },
