  ...
  <div class="flex flex-col h-screen">
    ...
    <div class="md:hidden flex items-center justify-between bg-white border-b border-gray-200 px-4 py-3">
      <div class="flex items-center space-x-2">
        <img src="https://fs.cdn-chatium.io/get/image_gc_dQ8uxvoDUR.512x512.png" alt="Chatium" class="w-6 h-6 rounded" />
        <span class="text-sm font-semibold text-gray-900">{{ ctx.t('Chatium Documentation') }}</span>
      </div>
    ...
    <div class="flex flex-1 max-w-7xl mx-auto w-full">
      ...
      <div v-else :class="[
        ...
        <div class="text-center">
          ...
          />
          <h1 class="text-3xl font-bold mb-2" style="color: #333;">{{ ctx.t('Chatium Documentation') }}</h1>
...
import { apiDocumentsTreeRoute, apiDocumentCreateRoute, apiDocumentDeleteRoute, apiDocumentUpdateRoute, apiDocumentsListRoute, apiDocumentsSeedRoute } from '../api/documents'
...
async function handleNavigate(documentId) {
  ...
  if (documentId) {
    ...
    if (urlType.value === 'id') {
      ...
      newUrl = urlSlugPath
        ? `${basePath}/${urlSlugPath}`
        : `${basePath}/id/${documentId}`
    }
