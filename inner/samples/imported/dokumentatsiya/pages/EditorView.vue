<template>
  <div class="flex flex-col">
          ...
          <div v-if="nextArticle && !editMode" class="mt-12 mb-8">
            ...
            >
              <div class="flex items-center justify-between">
                ...
                <div class="ml-4">
                  <i class="fas fa-arrow-right text-2xl text-blue-600 group-hover:translate-x-1 transition-transform"></i>
                </div>
              </div>
            </a>
          </div>
    ...
    <div v-if="ctx.user?.is('Admin') && !isViewMode" class="fixed bottom-6 right-6 flex items-center space-x-3 bg-white rounded-lg shadow-lg p-2">
      <button
        @click="saveDocument"
...
import { apiDocumentByIdRoute, apiDocumentUpdateRoute, apiDocumentNextRoute } from '../api/documents'
...
watch(() => hasUnsavedChanges.value, (newVal) => {
