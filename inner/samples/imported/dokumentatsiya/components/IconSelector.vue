    ...
    <div class="bg-white rounded-lg shadow-xl w-full max-w-3xl p-6 max-h-[90vh] overflow-y-auto">
      ...
      <div class="mb-6 border-b border-gray-200 pb-4">
        ...
        <div class="flex items-center gap-4">
          ...
          <div v-if="uploadedImageHash && uploadedImageHash !== currentImageHash" class="flex items-center gap-2">
            <img
...
const availableIcons = [
  // Documents
  'file', 'file-lines', 'file-pdf', 'file-word', 'file-excel',
  'file-code', 'file-archive', 'file-image', 'file-invoice',
  'file-contract', 'file-signature', 'file-medical', 'file-prescription',
  
  // Books & References
  'book', 'book-open', 'book-reader', 'bookmark', 'atlas',
  'graduation-cap', 'chalkboard',
  
  // Folders
  'folder', 'folder-open', 'folder-plus', 'archive', 'folder-tree',
  
  // Writing & Editing
  'pen', 'pencil', 'pen-fancy', 'pen-to-square',
  'feather', 'highlighter', 'marker', 'pen-nib', 'pen-clip',
  
  // Common Actions
  'check', 'xmark', 'plus', 'minus', 'equals',
  'asterisk', 'exclamation', 'question', 'info', 'circle-exclamation',
  'ban', 'arrow-rotate-left', 'arrow-rotate-right',
  
  // Favorites & Ratings
  'star', 'star-half', 'heart', 'thumbs-up', 'thumbs-down',
  
  // UI & Interaction
  'lightbulb', 'bell', 'clock', 'clock-rotate-left', 'arrows-rotate', 'rotate',
  'arrow-up', 'arrow-down', 'arrow-left', 'arrow-right',
  'chevron-up', 'chevron-down', 'chevron-left', 'chevron-right',
  'expand', 'compress',
  
  // Settings & Configuration
  'gear', 'sliders', 'wrench', 'hammer',
  'screwdriver', 'screwdriver-wrench',
  
  // Development
  'code', 'code-branch', 'terminal',
  
  // Data & Charts
  'database', 'chart-bar', 'chart-line', 'chart-pie',
  'signal', 'gauge', 'gauge-high',
  
  // Organization
  'puzzle-piece', 'cube', 'cubes', 'box',
  'layer-group', 'sitemap', 'diagram-project',
  
  // Lists & Navigation
  'list', 'list-ul', 'list-ol', 'list-check', 'indent',
  'outdent', 'align-left', 'align-center', 'align-right',
  'bars',
  
  // Communication
  'comment', 'comments', 'envelope', 'message',
  'phone', 'users', 'user-circle', 'user',
  'handshake', 'user-tie',
  
  // Media
  'image', 'images', 'video', 'film',
  'play', 'pause', 'stop', 'volume-high', 'volume-xmark',
  'camera', 'camera-retro', 'eye', 'eye-slash', 'magnifying-glass',
  
  // System
  'house', 'building', 'location-dot', 'map', 'compass',
  'globe', 'earth-americas', 'wifi',
  'cloud', 'cloud-arrow-up', 'cloud-arrow-down', 'server',
  'desktop', 'mobile', 'tablet', 'laptop', 'keyboard',
  'computer-mouse', 'print', 'floppy-disk', 'download', 'upload',
  'share-nodes', 'link', 'paperclip', 'thumbtack', 'tag', 'tags',
  'trash', 'trash-can', 'recycle', 'lock', 'unlock', 'key',
  
  // Status
  'circle', 'circle-pause', 'circle-play',
  'hourglass', 'hourglass-half', 'spinner',
  
  // Misc
  'apple', 'windows', 'android', 'linux',
  'copyright', 'registered', 'trademark', 'certificate',
  'medal', 'trophy', 'award', 'ribbon',
  
  // Additional
  'rocket', 'fire', 'bolt', 'wand-magic-sparkles',
  'shield', 'shield-halved', 'bug', 'flask', 'microscope',
  'atom', 'dna', 'pills', 'syringe', 'heart-pulse',
  'briefcase', 'calendar', 'clipboard', 'clipboard-list', 'clipboard-check',
  'flag', 'flag-checkered', 'bell-slash',
  'brain', 'circle-info', 'circle-question', 'triangle-exclamation',
  'circle-check', 'circle-xmark', 'square-check', 'square-xmark'
]
...
watch(() => props.currentImageHash, (newHash) => {
