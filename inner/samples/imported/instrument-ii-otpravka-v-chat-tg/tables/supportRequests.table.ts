...
export const TSendposttochannelSupportRequestsTIR = Heap.Table(
  't_sendposttochannel_supportRequests_W2t',
  {
    ...
    telegramMessageId: Heap.Optional(Heap.Number({ customMeta: { title: 'ID сообщения в Telegram' } })),
  },
...
export type TSendposttochannelSupportRequestsTIRRowJson = typeof TSendposttochannelSupportRequestsTIR.JsonT
