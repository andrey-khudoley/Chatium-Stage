...
export const ChatsRbf = Heap.Table(
  't_chats_pKpi6RJc_tpfnjk_eZn_eZn',
  {
    ...
    chatId: Heap.Optional(
      Heap.String({ customMeta: { title: 'ID чата' }, searchable: { langs: ['ru', 'en'], embeddings: true } })
    ),
    personId: Heap.Optional(
      Heap.String({ customMeta: { title: 'ID персоны' }, searchable: { langs: ['ru', 'en'], embeddings: true } })
    ),
    title: Heap.Optional(
