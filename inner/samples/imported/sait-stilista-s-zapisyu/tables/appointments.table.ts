...
export const TStylistBookingAppointmentsKrw = Heap.Table(
  't_stylistBooking_appointments_fsu',
  {
    ...
    email: Heap.Optional(
      Heap.String({ customMeta: { title: 'Email' }, searchable: { langs: ['ru', 'en'], embeddings: true } }),
    ),
    service: Heap.Optional(
      Heap.String({ customMeta: { title: 'Услуга' }, searchable: { langs: ['ru', 'en'], embeddings: true } }),
    ),
    date: Heap.Optional(
      Heap.String({ customMeta: { title: 'Дата' }, searchable: { langs: ['ru', 'en'], embeddings: true } }),
    ),
    time: Heap.Optional(
      Heap.String({ customMeta: { title: 'Время' }, searchable: { langs: ['ru', 'en'], embeddings: true } }),
    ),
