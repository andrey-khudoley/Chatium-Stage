...
// @shared-route
export const apiGetGroupSuggestionsRoute = app.body(s => ({
  ...
  try {
    ...
    return {
      ...
      settings: {
        ...
        messageWrapper: settings?.messageWrapper || '🤖 <b>Сообщение от ИИ агента</b>\n\n{TEXT}\n\n<i>Отправлено автоматически</i>',
...
export const apiTestToolRoute = app.body(s => ({
  ...
  try {
    const { tgManagerId, groupOrChannelId, messageWrapper, buttons, disableLinkPreview } = req.body
