...
export const TKalendarZapisiAppointmentsX1J = Heap.Table(
  't_kalendar-zapisi_appointments_Hog',
  {
    ...
    telegramId: Heap.Optional(
      Heap.String({ customMeta: { title: 'Telegram ID' }, searchable: { langs: ['ru', 'en'], embeddings: true } }),
    ),
    email: Heap.Optional(
      Heap.String({ customMeta: { title: 'Почта' }, searchable: { langs: ['ru', 'en'], embeddings: true } }),
    ),
    ...
    notes: Heap.Optional(
      Heap.String({ customMeta: { title: 'Заметки' }, searchable: { langs: ['ru', 'en'], embeddings: true } }),
    ),
