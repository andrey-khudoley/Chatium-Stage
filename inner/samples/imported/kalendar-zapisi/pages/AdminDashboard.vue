    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-if="activeTab === 'settings'" class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-4">
          ...
          <div v-if="settingsMessage" :class="[
      ...
      <div v-if="activeTab === 'appointments'" class="space-y-6">
        ...
        <div class="flex gap-4 items-center">
          ...
          <div class="flex-1 text-center py-2">
            <p class="text-sm font-medium text-gray-600">
              {{ appointmentsViewDate.toLocaleDateString('ru-RU', { year: 'numeric', month: 'long', day: 'numeric' }) }}
            </p>
          </div>
          <button
        ...
        <!-- Calendar View -->
        <div v-if="appointments.length === 0" class="bg-white rounded-lg shadow p-8 text-center text-gray-500">
          Нет записей
        </div>
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <div class="p-2 space-y-1">
              ...
              >
                <span
                  :class="[
                    ...
                    apt.status === 'new' ? 'bg-yellow-500'
                      : apt.status === 'confirmed' ? 'bg-purple-500'
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-baseline gap-2 flex-wrap">
                    <span class="font-semibold text-sm text-gray-900">{{ apt.appointmentTime }}</span>
              ...
              <div v-if="dayEntry.appointments.length === 0" class="p-4 text-center text-gray-400 text-xs">
                Нет записей
              </div>
            </div>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-xl max-w-5xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div v-if="addAppointmentStep === 1" class="p-6 space-y-4">
              ...
              <div class="flex gap-3 items-center justify-center">
                ...
                <div class="text-center py-2 px-4 bg-gray-50 rounded-lg">
                  <p class="text-sm font-medium text-gray-900">
                    {{ scheduleViewDate.toLocaleDateString('ru-RU', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' }) }}
                  </p>
                </div>
                <button
                  @click="goToNextDay"
              ...
              <div v-else class="space-y-2">
                <div
                  ...
                  :class="[
                    slot.available ? 'border-green-300 bg-green-50 hover:bg-green-100'
                      : slot.booked ? 'border-red-300 bg-red-50 cursor-not-allowed'
                      : 'border-gray-300 bg-gray-50 cursor-not-allowed'
                  ]"
                  @click="slot.available ? selectSlot(scheduleViewDate.toISOString().split('T')[0], slot.time) : null"
                >
                ...
                <div v-if="(scheduleData[scheduleViewDate.toISOString().split('T')[0]] || []).length === 0" class="text-center py-8 text-gray-500">
            ...
            <div v-else-if="addAppointmentStep === 2" class="p-6 space-y-4">
              <div class="flex justify-between items-center">
                <div>
                  ...
                  <p class="text-sm text-gray-600 mt-1">
                    Дата: {{ new Date(newAppointment.appointmentDate).toLocaleDateString('ru-RU') }}, 
              ...
              <div class="space-y-3">
                ...
                <div v-if="addAppointmentError" class="p-3 bg-red-50 text-red-700 rounded-lg text-sm">
                  {{ addAppointmentError }}
                </div>
              </div>
          ...
          <div class="bg-white rounded-lg shadow-xl max-w-md w-full p-6 space-y-4">
            ...
            <div class="space-y-3 text-sm">
              <div>
                ...
                <span class="ml-2 font-medium">{{ new Date(selectedAppointment.appointmentDate).toLocaleDateString('ru-RU') }}</span>
              </div>
              <div>
              ...
              <div v-if="selectedAppointment.comments">
                ...
                <p class="ml-0 mt-1 p-2 bg-gray-50 rounded text-gray-700">{{ selectedAppointment.comments }}</p>
              </div>
              <div>
                ...
                <select
                  ...
                  :class="[
                    ...
                    selectedAppointment.status === 'new' ? 'bg-yellow-50'
                      : selectedAppointment.status === 'confirmed' ? 'bg-purple-50'
                      : selectedAppointment.status === 'in_progress' ? 'bg-blue-50'
            ...
            <tbody class="divide-y divide-gray-200">
              <tr v-for="admin in admins" :key="admin.id" class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 text-sm">
                  <span v-if="admin.isOwner" class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-700 border border-purple-200">
...
const workDaysArray = computed(() => {
  ...
  return settings.value.workDaysOfWeek.split(',').map(d => parseInt(d.trim())).filter(d => !isNaN(d));
});
...
async function createAppointment() {
  if (!newAppointment.value.name || !newAppointment.value.appointmentDate || !newAppointment.value.appointmentTime) {
