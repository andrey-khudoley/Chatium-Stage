...
export const TWebinarRoomWebinarRoomFormSubmissions = Heap.Table(
  ...
  {
    form: Heap.Optional(
      Heap.RefLink('webinar-room-episode-forms_ssq', { customMeta: { title: 'Форма' }, onDelete: 'none' }),
    ),
    episode: Heap.Optional(Heap.RefLink('webinar-room-episodes_S58', { customMeta: { title: 'Эфир' }, onDelete: 'none' })),
    autowebinar: Heap.Optional(
      Heap.RefLink('t_webinar_room_webinar_room_autowebinars_CRj', { customMeta: { title: 'Автовебинар' }, onDelete: 'none' }),
    ),
