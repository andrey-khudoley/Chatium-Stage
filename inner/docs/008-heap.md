...
export const TableName = Heap.Table('t__project__table__xyz', {
...
export const Users = Heap.Table('t__project__users__Xy1Zw2', {
  firstName: Heap.Optional(Heap.String({
    customMeta: { title: 'Имя' },
    searchable: { langs: ['ru', 'en'], embeddings: false }
  })),
  lastName: Heap.Optional(Heap.String({
  ...
  isActive: Heap.Optional(Heap.Boolean({
...
export const Orders = Heap.Table('t__project__orders__Mn3Op4', {
  ...
  product: Heap.Optional(Heap.RefLink('t__project__products__Ab1Cd2', {
    customMeta: { title: 'Продукт' },
    onDelete: 'none',
  })),
  quantity: Heap.Optional(Heap.Number({
...
export const Campaigns = Heap.Table('t__saas-ref__campaign__8Hn4Lx', {
  title: Heap.Optional(Heap.String({ customMeta: { title: 'Название' } })),
  ownerUserId: Heap.Optional(Heap.UserRefLink({
    customMeta: { title: 'Владелец' },
    onDelete: 'none',
  })),
}, { customMeta: { title: 'Кампании', description: 'Кампании' } })

export const CampaignMembers = Heap.Table('t__saas-ref__campaign_member__2Km5Ny', {
  campaignId: Heap.Optional(Heap.RefLink('t__saas-ref__campaign__8Hn4Lx', {
    customMeta: { title: 'Кампания' },
    onDelete: 'none',
  })),
  userId: Heap.Optional(Heap.UserRefLink({
