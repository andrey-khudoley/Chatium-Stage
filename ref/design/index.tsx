      ...
      <head>
        ...
        <style>{`
          ...
          #tv-glitch::before {
            ...
            /* Убрали box-shadow, который создавал светлую полосу */
          }
        ...
        <script>{`
          (function() {
            ...
            function setupGlitchEffect() {
              var glitchElement = document.getElementById('tv-glitch');
              var body = document.body;
              if (!glitchElement) return;
              
              var glitchDuration = 1000; // 1 секунда
              
              // Одна помеха через 2.5 секунды после скрытия прелоадера
              setTimeout(function() {
            ...
            // Запускаем эффект после завершения bootloader
  ...
  return (
    <html>
      ...
      <body>
        <div class="min-h-screen bg-gray-50 flex items-center justify-center">
          <div class="text-center">
            <h1 class="text-2xl font-bold mb-4">Управление ботами</h1>
            <p class="text-gray-600">Страница в разработке</p>
          </div>
        </div>
      </body>
