<template>
  <div class="login-card">
    ...
    <!-- Выбор метода авторизации (Телефон/Email) -->
    ...
    <!-- Кнопка Telegram -->
    <div v-if="isTelegramEnabled" :class="{'mt-6': isPhoneEnabled || isEmailEnabled}">
      <div v-if="isPhoneEnabled || isEmailEnabled" class="relative">
      ...
      <button 
        ...
        class="w-full mt-4 font-medium py-3 px-4 rounded-lg transition-all flex items-center justify-center"
 ...
 * Получает OAuth URL и перенаправляет пользователя
 */
