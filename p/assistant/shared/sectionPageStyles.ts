// @shared
/**
 * Общие стили для страниц разделов (Календарь, Мой день, Неделя, Привычки, Блокнот).
 * Используются в web/calendar, web/my-day, web/week, web/habits, web/notebook.
 */

export function getSectionPageLayoutStyles(getPreloaderStyles: () => string): string {
  return `
    html {
      margin: 0;
      padding: 0;
...
export const sectionPageVariablesStyles = `
  :root {
    --color-bg: #0a0a0a;
