...
## Текущее состояние
- Главная, админка, профиль и логин существуют как минимальные страницы. На главной ниже hero размещены пять разделов: **Календарь**, **Мой день**, **Неделя**, **Привычки**, **Блокнот** — каждый ведёт на отдельную страницу-заглушку. На страницах разделов — навигация SectionNav (Главная + все пять разделов). Роуты: `web/calendar`, `web/my-day`, `web/week`, `web/habits`, `web/notebook` (публичный доступ, без бизнес-логики). Адаптивная вёрстка и единый визуальный стиль (CRT-тема, акценты).
