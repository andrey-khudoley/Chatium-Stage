...
## Назначение
Проект `p/assistant` для Chatium. Базовая структура: главная страница (карточки «Мой журнал», «Мои задачи», «Диалоги»), страница «Мой журнал» (`/web/journal` — меню разделов; вкладка «Блокнот» — заметки в Heap, список, чтение в панели, модальное создание/редактирование, удаление), админка, профиль, логин и тестовая страница.
