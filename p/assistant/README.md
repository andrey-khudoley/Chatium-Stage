...
## Назначение
Проект `p/assistant` для Chatium. Базовая структура: главная страница (карточки «Мой журнал», «Мои задачи», «Диалоги»), страница «Мой журнал» (`/web/journal` — меню разделов и панели-заглушки), админка, профиль, логин и тестовая страница.
