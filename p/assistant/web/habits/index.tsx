...
import { HABITS_PAGE_NAME, getPageTitle, getHeaderText } from '../../config/project'
import * as settingsLib from '../../lib/settings.lib'
import { customScrollbarStyles } from '../../styles'

const LOG_PATH = 'web/habits/index'

export const habitsPageRoute = app.html('/', async (ctx) => {
  await loggerLib.writeServerLog(ctx, {
    severity: 7,
    message: `[${LOG_PATH}] Запрос страницы «Привычки»`,
  ...
  return (
    <html>
      <head>
        <title>{getPageTitle(HABITS_PAGE_NAME, projectName)}</title>
      ...
      <body>
        ...
        <HabitsPage
          projectTitle={getHeaderText(HABITS_PAGE_NAME, projectName)}
...
export default habitsPageRoute
