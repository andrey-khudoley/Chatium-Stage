...
import { MY_DAY_PAGE_NAME, getPageTitle, getHeaderText } from '../../config/project'
...
export const myDayPageRoute = app.html('/', async (ctx) => {
  ...
  return (
    <html>
      <head>
        <title>{getPageTitle(MY_DAY_PAGE_NAME, projectName)}</title>
      ...
      <body>
        ...
        <MyDayPage
          projectTitle={getHeaderText(MY_DAY_PAGE_NAME, projectName)}
