...
import { CALENDAR_PAGE_NAME, getPageTitle, getHeaderText } from '../../config/project'
import * as settingsLib from '../../lib/settings.lib'
import { customScrollbarStyles } from '../../styles'

const LOG_PATH = 'web/calendar/index'

export const calendarPageRoute = app.html('/', async (ctx) => {
  await loggerLib.writeServerLog(ctx, {
    severity: 7,
    message: `[${LOG_PATH}] Запрос страницы календаря`,
  ...
  return (
    <html>
      <head>
        <title>{getPageTitle(CALENDAR_PAGE_NAME, projectName)}</title>
      ...
      <body>
        ...
        <CalendarPage
          projectTitle={getHeaderText(CALENDAR_PAGE_NAME, projectName)}
