...
onMounted(() => {
  ...
  const typeDescription = () => {
    const descriptionText = 'Управляйте партнёрской программой'
    ...
    const descInterval = setInterval(() => {
      if (descIndex < descriptionText.length) {
        ...
        // Перемещаем курсор в конец заголовка
    ...
    <main class="content-wrapper flex-1 relative z-10 min-h-0 overflow-y-auto">
      <div class="content-inner">
        ...
        <section class="hero-section" :class="{ 'hero-ready': bootLoaderDone }">
          <div class="hero-icon-wrapper" :class="{ 'hero-icon-visible': bootLoaderDone }">
          ...
          <p class="hero-help" @click="triggerGlitch">
