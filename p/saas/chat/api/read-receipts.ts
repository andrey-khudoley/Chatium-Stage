...
import { findFeedMessages, findFeedParticipants, getFeedById } from '@app/feed'
...
export const apiReadReceiptsGetRoute = app.get('/:feedId/:messageId', async (ctx, req) => {
  requireRealUser(ctx)
...
export const apiReadReceiptsStatsRoute = app.get('/:feedId/stats', async (ctx, req) => {
  requireRealUser(ctx)
