...
const isMultiline = computed(() => props.message.includes('\n'))
      ...
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-body">
          <div class="modal-message">
            <pre v-if="isMultiline" class="message-pre" v-html="formattedMessage"></pre>
            <p v-else class="message-text" v-html="formattedMessage"></p>
          </div>
        </div>
...
.message-pre :deep(.message-value) {
