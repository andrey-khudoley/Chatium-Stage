...
export const DEFAULT_PROJECT_TITLE = 'GetCourse API Gateway'
...
export const BODY_TEXT = 'Gateway GetCourse'

/** Подзаголовок домашней страницы */
export const BODY_SUBTEXT =
  'Централизованный слой op + args → GC API (новый и Legacy). Каркас на базе template_project; см. спецификацию слоя Gateway в материалах курса.'
