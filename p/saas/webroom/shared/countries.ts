...
/**
 * Маппинг кодов стран ISO 3166-1 alpha-2 в русские названия
 */
export const COUNTRY_NAMES: Record<string, string> = {
  ...
  'BL': 'Сен-Бартелеми', 'BM': 'Бермудские острова', 'BN': 'Бруней', 'BO': 'Боливия', 'BQ': 'Бонайре',
  'BR': 'Бразилия', 'BS': 'Багамские острова', 'BT': 'Бутан', 'BV': 'Остров Буве', 'BW': 'Ботсвана',
  'BY': 'Беларусь', 'BZ': 'Белиз', 'CA': 'Канада', 'CC': 'Кокосовые острова', 'CD': 'Конго (ДРК)',
  ...
  'HM': 'Остров Херд и острова Макдональд', 'HN': 'Гондурас', 'HR': 'Хорватия', 'HT': 'Гаити', 'HU': 'Венгрия',
  ...
  'KG': 'Киргизия', 'KH': 'Камбоджа', 'KI': 'Кирибати', 'KM': 'Коморские острова', 'KN': 'Сент-Китс и Невис',
  'KP': 'КНДР', 'KR': 'Республика Корея', 'KW': 'Кувейт', 'KY': 'Каймановы острова', 'KZ': 'Казахстан',
  ...
  'PN': 'Острова Питкэрн', 'PR': 'Пуэрто-Рико', 'PS': 'Палестина', 'PT': 'Португалия', 'PW': 'Палау',
  'PY': 'Парагвай', 'QA': 'Катар', 'RE': 'Реюньон', 'RO': 'Румыния', 'RS': 'Сербия',
  'RU': 'Россия', 'RW': 'Руанда', 'SA': 'Саудовская Аравия', 'SB': 'Соломоновы острова', 'SC': 'Сейшельские острова',
  'SD': 'Судан', 'SE': 'Швеция', 'SG': 'Сингапур', 'SH': 'Остров Святой Елены', 'SI': 'Словения',
  'SJ': 'Шпицберген и Ян-Майен', 'SK': 'Словакия', 'SL': 'Сьерра-Леоне', 'SM': 'Сан-Марино', 'SN': 'Сенегал',
  'SO': 'Сомали', 'SR': 'Суринам', 'SS': 'Южный Судан', 'ST': 'Сан-Томе и Принсипи', 'SV': 'Сальвадор',
  'SX': 'Синт-Мартен', 'SY': 'Сирия', 'SZ': 'Эсватини', 'TC': 'Теркс и Кайкос', 'TD': 'Чад',
  ...
  'UG': 'Уганда', 'UM': 'Малые Тихоокеанские Острова США', 'US': 'США', 'UY': 'Уругвай', 'UZ': 'Узбекистан',
  'VA': 'Ватикан', 'VC': 'Сент-Винсент и Гренадины', 'VE': 'Венесуэла', 'VG': 'Британские Виргинские острова', 'VI': 'Виргинские острова США',
  'VN': 'Вьетнам', 'VU': 'Вануату', 'WF': 'Уоллис и Футуна', 'WS': 'Самоа', 'YE': 'Йемен',
  'YT': 'Майотта', 'ZA': 'ЮАР', 'ZM': 'Замбия', 'ZW': 'Зимбабве',
  'Unknown': 'Неизвестно',
}

/**
 * Получить русское название страны по коду ISO 3166-1 alpha-2
 */
