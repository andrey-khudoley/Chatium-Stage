/**
 * GET /v1/operations — каталог операций gateway (operation-manual §3.3, §3.4).
 *
 * Без проверки заголовков `X-Lp-Apikey`/`X-Lp-Login` (§3.3) — исходящего вызова к LifePay нет.
 * Возвращает wire-форму каталога: `data: { catalogSchemaVersion, operations[] }`.
 */
