    ...
    <main class="tp-wrap flex flex-col flex-1 relative z-10 min-h-0 w-full min-w-0 overflow-hidden">
      <div class="tp" :class="{ ready: bootLoaderDone }">
        <TestsToolbar
          ...
          :isRequestTestTab="isRequestTestTab"
          :showRequestTestTab="
            !!(props.isAdmin && props.operationsCatalog && props.operationsCatalog.length)
          "
          @set-tab="(t: 'unit' | 'integration' | 'http' | 'request-test') => (testsSuiteTab = t)"
