          ...
          <div class="ap-main content-wrapper">
            ...
            <div class="ap-cfg-row">
              <section class="ap-card ap-card--stagger-2">
                ...
                />
                <p v-if="lpTestApikeyError" class="ap-err"><i class="fas fa-exclamation-circle"></i> {{ lpTestApikeyError }}</p>
              </section>
              ...
              <section class="ap-card ap-card--stagger-3">
                ...
                />
                <p v-if="lpTestLoginError" class="ap-err"><i class="fas fa-exclamation-circle"></i> {{ lpTestLoginError }}</p>
              </section>
            </div>
          </div>
