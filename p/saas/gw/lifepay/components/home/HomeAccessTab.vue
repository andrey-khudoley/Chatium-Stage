<script>
// Вкладка «Доступы» (только для админа): пригласительные ссылки и выданные доступы.
// Данные — из HomePage; действия (создать/отозвать/обновить) — через emit. CSS глобальный.
import { formatDateTime, inviteStatusLabel } from '../../shared/lifepayHomeFormat'
