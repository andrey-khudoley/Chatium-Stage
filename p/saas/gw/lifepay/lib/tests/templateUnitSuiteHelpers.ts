/**
 * Общий тип результата и хелперы (push/tryPush, mock window, матрица shouldLog) для
 * юнит-набора шаблона (см. templateUnitSuite.ts). Вынесены в отдельный модуль, чтобы
 * группы проверок можно было раскидать по файлам без дублирования.
 */
