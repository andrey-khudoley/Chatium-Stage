// @shared
/**
 * Методы загрузки данных, фильтра, raw-модалки и управления доступами главной
 * панели (pages/HomePage.vue). Вынесено в миксин ради лимита размера файла;
 * `this` — экземпляр HomePage (Options API). Поведение сохранено дословно.
 */
import { createComponentLogger } from '../shared/logger'

const log = createComponentLogger('GatewayHomePage')

export const lavatopHomePageMethodsMixin = {
  methods: {
    ...
    async doReforward(this: any, id: unknown) {
