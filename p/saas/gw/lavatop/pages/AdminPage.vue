...
// Настройки шлюза Lava.Top — редактируются админом, сохраняются с дебаунсом (как имя проекта).
...
// --- Настройки шлюза Lava.Top: загрузка/сохранение ---
          ...
          <div class="ap-main content-wrapper">
              ...
              <section class="ap-card ap-card--stagger-2">
                <div class="ap-card-hd">
                  ...
                  >
                    <i
                      :class="
                        lavaTestApikeySaveStatus === 'saved' ? 'fas fa-check' : 'fas fa-times'
                      "
                    ></i>
                ...
                />
                <p class="ap-hint">
                  Подставляется в форме «Создать запрос» (заголовок X-Lava-Apikey).
                </p>
              ...
              <section class="ap-card ap-card--stagger-3">
                <div class="ap-card-hd">
                  ...
                  <span
                    ...
                    class="ap-badge"
                    :class="
                      lavaWebhookSecretSaveStatus === 'saved' ? 'ap-badge--ok' : 'ap-badge--err'
                    "
                  >
                    <i
                      :class="
                        lavaWebhookSecretSaveStatus === 'saved' ? 'fas fa-check' : 'fas fa-times'
                      "
                    ></i>
                ...
                />
                <p class="ap-hint">
                  Сверяется с заголовком входящих вебхуков. Без него приём вернёт 500.
                </p>
            ...
            <section class="ap-card ap-card--stagger-3">
              <div class="ap-card-hd">
                ...
                >
                  <i
                    :class="lavaBaseUrlSaveStatus === 'saved' ? 'fas fa-check' : 'fas fa-times'"
                  ></i>
