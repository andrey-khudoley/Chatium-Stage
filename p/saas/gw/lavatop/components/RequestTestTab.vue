...
const fieldErrors = computed<Record<string, string>>(() => {
  ...
  errs['X-Lava-Apikey'] = validateApikey(xLavaApikey.value)
...
// «Ответ вышестоящего сервиса (Lava.Top)» — содержимое, которое гейтвей вернул из data/error.
  ...
  <div class="rt">
    ...
    <template v-if="selectedOpEntry">
      ...
      <div v-if="responseSnapshot" class="rt-snap">
        <div class="rt-snap-hd">Ответ вышестоящего сервиса (Lava.Top)</div>
