        ...
        <div class="ap-grid">
          <div class="ap-main content-wrapper">
            ...
            <section class="ap-card ap-card--stagger-4 ap-card--gc">
              ...
              <p class="ap-gc-lead">
                Значения пишутся в Heap через <code class="ap-gc-code">api/settings/save</code>.
                Пустые и пробельные значения ключей отклоняются; хост — без схемы и без пробелов,
                как для заголовка <code class="ap-gc-code">X-Gc-School-Host</code> (разд. 5.4 и 2.5
                в gateway-operation-manual).
              </p>

              <div class="ap-gc-field">
                <label class="ap-gc-label" for="gc-dev-key-input"
                  >Ключ разработчика GetCourse</label
                >
                <div class="ap-gc-input-row">
                  ...
                  >
                    <i
                      :class="showGcDevKey ? 'fas fa-eye-slash' : 'fas fa-eye'"
                      aria-hidden="true"
                    ></i>
                  </button>
                </div>
              ...
              <div class="ap-gc-field">
                ...
                <div class="ap-gc-input-row">
                  ...
                  >
                    <i
                      :class="showGcSchoolKey ? 'fas fa-eye-slash' : 'fas fa-eye'"
                      aria-hidden="true"
                    ></i>
                  </button>
                </div>
              ...
              <div class="ap-gc-actions">
                ...
                >
                  <i
                    :class="gcGatewaySaveLoading ? 'fas fa-circle-notch fa-spin' : 'fas fa-save'"
                  ></i>
            ...
            <section class="ap-card ap-card--stagger-4 ap-kv">
              ...
              <p class="ap-gc-lead">
                ...
                >, <code class="ap-gc-code">gc_test_school_api_key</code>) сюда не попадают — они
                задаются в форме «Настройки GetCourse» выше.
              </p>
                ...
                <ul v-else class="ap-kv-rows">
                  <li v-for="item in kvItems" :key="item.key" class="ap-kv-item">
                    ...
                    <span class="ap-kv-value">{{
                      arbitrarySettingValueToString(item.value) || '—'
                    }}</span>
