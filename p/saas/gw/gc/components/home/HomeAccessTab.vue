<script>
// Презентация вкладки «Доступы» (Admin): пригласительные ссылки и выданные доступы.
// Данные приходят из HomePage через пропсы; действия — через emit. CSS глобальный.
import { formatDateTime, inviteStatusLabel } from '../../shared/gcHomeFormat'
