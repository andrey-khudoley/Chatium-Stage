...
import DesignCatalogIndexPage from '../../pages/DesignCatalogIndexPage.vue'
...
import { getGoogleFontsHref, getUiBootstrapScript } from '../../shared/design/system'
import { DESIGN_CATALOG_MODULES } from '../../shared/design/catalog'

const LOG_PATH = 'web/design/index'
const DESIGN_PAGE_NAME = 'Design Catalog'

export const designCatalogPageRoute = app.html('/', async (ctx, req) => {
  await loggerLib.writeServerLog(ctx, {
    severity: 7,
    message: `[${LOG_PATH}] Request design catalog page`,
  ...
  const modules = DESIGN_CATALOG_MODULES.map((module) => ({
    ...module,
    demoUrl: getFullUrl(`./web/design/${module.slug}`)
  }))

  return (
    <html>
      <head>
        <title>{getPageTitle(DESIGN_PAGE_NAME, projectName)}</title>
      ...
      <body>
        ...
        <DesignCatalogIndexPage
          projectTitle={getHeaderText(DESIGN_PAGE_NAME, projectName)}
...
export default designCatalogPageRoute
