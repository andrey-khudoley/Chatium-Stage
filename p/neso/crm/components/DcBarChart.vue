...
.dc-bar-chart {
  ...
  --bar-inactive-top: rgba(255, 255, 255, 0.12);
  --bar-inactive-bottom: rgba(131, 148, 72, 0.5);
...
.dc-bar-chart.theme-light {
  ...
  --text2: #2f3f2c;
  --text3: #4f5e49;
  /* Верх с зелёным оттенком, чтобы не сливаться с кремовым фоном карточки */
  --bar-inactive-top: rgba(79, 111, 47, 0.22);
  --bar-inactive-bottom: rgba(79, 111, 47, 0.58);
  --bar-active-top: #a8c76a;
  --bar-active-mid: #8fb855;
  --bar-active-bottom: #3d5524;
  --bar-gloss: rgba(255, 255, 255, 0.72);
  --bar-gloss-active: rgba(255, 255, 255, 0.6);
  --bar-shadow-inner: rgba(0, 0, 0, 0.08);
  --bar-shadow-outer: rgba(79, 111, 47, 0.16);
  --bar-glow: rgba(79, 111, 47, 0.28);
  --bar-glass-border: rgba(255, 255, 255, 0.56);
  --bar-inactive-border: rgba(79, 111, 47, 0.28);
  --bar-lift-1: rgba(79, 111, 47, 0.16);
  --bar-lift-2: rgba(79, 111, 47, 0.1);
  --bar-lift-offset: 4px;
}
.dc-bar-chart.theme-light .dc-bar:not(.active) {
  border-top-color: var(--bar-inactive-border);
  border-left-color: rgba(79, 111, 47, 0.18);
  box-shadow:
...
.dc-bar {
  ...
  border-right: none;
  border-bottom: none;
  /* Приподнятое стекло: внутренний блик сверху/слева, без нижней inset-тени (убирает артефакт полоски) */
  box-shadow:
