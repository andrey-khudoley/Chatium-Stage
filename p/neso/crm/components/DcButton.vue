...
.dc-btn.theme-light.variant-secondary {
  ...
  border: 1px solid rgba(79, 111, 47, 0.24);
}
.dc-btn.variant-secondary:hover { background: rgba(255,255,255,0.14); transform: translateY(-1px); }
.dc-btn.theme-light.variant-secondary:hover { background: rgba(79, 111, 47, 0.2); }
...
.dc-btn.theme-light.variant-ghost:hover:not(.disabled) {
  ...
  box-shadow:
    ...
    2px 4px 10px rgba(79, 111, 47, 0.12),
    1px 6px 14px rgba(79, 111, 47, 0.08);
}
