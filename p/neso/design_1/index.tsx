...
const pageStyles = `
  * { 
  ...
  body {
    ...
    background: linear-gradient(90deg, var(--bg-dark) 0%, var(--bg-dark) 50%, var(--bg-light) 50%, var(--bg-light) 100%);
    display: flex;
  ...
  .orb-1 {
    width: 40vw;
    height: 40vw;
    background: radial-gradient(circle, rgba(175, 196, 95, 0.3), transparent 70%);
    top: -10%;
    left: -10%;
    animation-delay: 0s;
  }
  ...
  .orb-2 {
    width: 35vw;
    height: 35vw;
    background: radial-gradient(circle, rgba(79, 111, 47, 0.25), transparent 70%);
    bottom: -10%;
    right: -10%;
    animation-delay: -10s;
  }
  ...
  .logo {
    ...
    margin: 0 auto 2rem;
    box-shadow: 
      0 8px 32px rgba(175, 196, 95, 0.4),
  ...
  .theme-card::before {
    ...
    border-radius: 24px;
    padding: 1px;
    background: linear-gradient(135deg, rgba(175, 196, 95, 0.3), transparent 50%);
  ...
  .theme-card.light {
    ...
    color: var(--text-dark);
    box-shadow: 
      0 8px 32px rgba(79, 111, 47, 0.15),
  ...
  .theme-card.dark:hover {
    box-shadow: 
      ...
      0 0 40px rgba(175, 196, 95, 0.2),
      inset 0 1px 0 rgba(255, 255, 255, 0.08);
  }
  
  .theme-card.light:hover {
    box-shadow: 
      0 16px 48px rgba(79, 111, 47, 0.2),
      0 0 40px rgba(255, 243, 202, 0.4),
    ...
    <html>
      ...
      <body>
        ...
        <div class="container">
          ...
          <p class="subtitle">Новая дизайн-система для CRM: солнечная листва и ночной лес</p>
          ...
          <div class="theme-cards">
            <a href={designDemoUrl} class="theme-card dark">
              ...
              <p class="theme-desc">Глубина, мягкий контраст, фокус на задаче. Светлячки как акцент.</p>
            ...
            <a href={designDemoLightUrl} class="theme-card light">
              ...
              <p class="theme-desc">Воздух, чистота, лёгкая иерархия. Цвет листвы как акцент.</p>
              <span class="theme-badge">
                <i class="fas fa-sparkles"></i>
                Light Theme
              </span>
