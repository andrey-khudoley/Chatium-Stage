...
const pageStyles = `
  html { margin: 0; background: #f8f6eb; }
...
const lightScrollbarStyles = `
  @supports not selector(::-webkit-scrollbar) {
    body, .content { scrollbar-width: thin; scrollbar-color: rgba(79, 111, 47, 0.2) rgba(248, 246, 235, 0.8); }
  }
  body::-webkit-scrollbar, .content::-webkit-scrollbar { width: 8px; height: 8px; }
  body::-webkit-scrollbar-track, .content::-webkit-scrollbar-track { background: rgba(248, 246, 235, 0.8); }
  body::-webkit-scrollbar-thumb, .content::-webkit-scrollbar-thumb { background: rgba(79, 111, 47, 0.18); border-radius: 4px; }
  body::-webkit-scrollbar-thumb:hover, .content::-webkit-scrollbar-thumb:hover { background: rgba(79, 111, 47, 0.3); }
`
