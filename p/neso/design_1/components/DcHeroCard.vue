...
.dc-hero-card.theme-light {
  ...
  box-shadow: 0 4px 32px rgba(79, 111, 47, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.9);
}
.dc-glow-spot {
  position: absolute;
  top: -30%; right: -15%;
...
.dc-sunray-diagonal {
  ...
  background: linear-gradient(135deg, transparent 0%, rgba(255, 243, 202, 0.25) 35%, transparent 55%);
  pointer-events: none;
