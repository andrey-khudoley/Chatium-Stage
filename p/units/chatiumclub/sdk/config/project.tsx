...
export const DEFAULT_PROJECT_TITLE = 'Chatium+GC SDK'
...
export const BODY_TEXT = 'Тонкий клиент Chatium+GC'

/** Подзаголовок домашней страницы */
export const BODY_SUBTEXT =
  'Стабильный вызов gateway (`op` + `args`). Спецификация слоя SDK — в материалах курса Chatium+GC.'
