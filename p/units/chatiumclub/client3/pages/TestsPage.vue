...
function getApiBaseUrl(): string {
  ...
  const basePath = path.replace(/\/$/, '') || '/p/units/chatiumclub/client3'
...
const HTTP_HTML_SNIPPETS: Record<string, string[]> = {
  index: ['window.__BOOT__', 'Webhook оплаты GetCourse (сценарий C)'],
  ...
  'web-tests': ['window.__BOOT__', 'chatiumclub-client3-tests-page']
}
