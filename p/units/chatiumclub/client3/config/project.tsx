...
export const DEFAULT_PROJECT_TITLE = 'Chatium Club · реакция на оплату'
...
export const BODY_TEXT = 'Webhook оплаты GetCourse (сценарий C)'

/** Подзаголовок домашней страницы */
export const BODY_SUBTEXT =
  'Входящий поток на gateway → действия в Chatium (`@app/sender`). Спецификация: `clients/payment-reaction`.'
