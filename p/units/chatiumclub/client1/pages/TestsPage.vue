...
function getApiBaseUrl(): string {
  ...
  const basePath = path.replace(/\/$/, '') || '/p/units/chatiumclub/client1'
...
const HTTP_HTML_SNIPPETS: Record<string, string[]> = {
  index: ['window.__BOOT__', 'Лид с лендинга (сценарий A)'],
  ...
  'web-tests': ['window.__BOOT__', 'chatiumclub-client1-tests-page']
}
