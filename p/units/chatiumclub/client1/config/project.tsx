...
export const DEFAULT_PROJECT_TITLE = 'Chatium Club · лид с лендинга'
...
export const BODY_TEXT = 'Лид с лендинга (сценарий A)'

/** Подзаголовок домашней страницы */
export const BODY_SUBTEXT =
  'Форма Chatium → тонкий клиент → gateway → GetCourse Legacy. Спецификация: `clients/landing-lead`.'
