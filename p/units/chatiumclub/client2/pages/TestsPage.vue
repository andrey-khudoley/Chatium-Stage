...
function getApiBaseUrl(): string {
  ...
  const basePath = path.replace(/\/$/, '') || '/p/units/chatiumclub/client2'
...
const HTTP_HTML_SNIPPETS: Record<string, string[]> = {
  index: ['window.__BOOT__', 'Таблица ответов квиза (сценарий B)'],
  ...
  'web-tests': ['window.__BOOT__', 'chatiumclub-client2-tests-page']
}
