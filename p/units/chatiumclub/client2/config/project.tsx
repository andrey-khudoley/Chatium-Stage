...
export const DEFAULT_PROJECT_TITLE = 'Chatium Club · таблица квиза'
...
export const BODY_TEXT = 'Таблица ответов квиза (сценарий B)'

/** Подзаголовок домашней страницы */
export const BODY_SUBTEXT =
  'Отправка данных в GetCourse через новый API. Спецификация: `clients/quiz-table`.'
