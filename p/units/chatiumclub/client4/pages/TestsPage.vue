...
function getApiBaseUrl(): string {
  ...
  const basePath = path.replace(/\/$/, '') || '/p/units/chatiumclub/client4'
...
const HTTP_HTML_SNIPPETS: Record<string, string[]> = {
  index: ['window.__BOOT__', 'Регистрация в GC → приветствие (сценарий D)'],
  ...
  'web-tests': ['window.__BOOT__', 'chatiumclub-client4-tests-page']
}
