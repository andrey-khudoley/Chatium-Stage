...
export const DEFAULT_PROJECT_TITLE = 'Chatium Club · приветствие при регистрации'
...
export const BODY_TEXT = 'Регистрация в GC → приветствие (сценарий D)'

/** Подзаголовок домашней страницы */
export const BODY_SUBTEXT =
  'Webhook или polling на gateway → `@app/sender`. Спецификация: `clients/registration-welcome`.'
