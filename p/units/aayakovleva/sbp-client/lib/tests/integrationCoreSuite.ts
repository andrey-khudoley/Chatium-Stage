/**
 * «Ядро» интеграционных проверок (settings/repos/dashboard/logger + регрессии).
 * Вынесено из integrationSuite ради лимита размера файла; дописывает результаты
 * в общий массив через runTemplateIntegrationChecks.
 */
