...
export const UNIT_TEST_BLOCKS: TestCatalogBlock[] = [
  ...
  },
  {
    ...
    tests: [
      ...
      { id: 'lp_webhook_multipart_files_data_string', title: 'extractMultipartTextPayload: req.files.data — строка' },
      { id: 'lp_webhook_multipart_files_data_wrapped', title: 'extractMultipartTextPayload: обёртка {content:"<json>"}' },
      { id: 'lp_webhook_multipart_fields_data', title: 'extractMultipartTextPayload: req.fields.data' },
      { id: 'lp_webhook_multipart_none', title: 'extractMultipartTextPayload: ни files ни fields' },
      { id: 'lp_webhook_multipart_buffer_data', title: 'extractMultipartTextPayload: Buffer-like' },
