/**
 * E2E-проверки и общие хвостовые сценарии (logger/log, юнит-набор, roundtrip
 * настроек, пагинация логов, dashboard reset flow, payload в recent,
 * сокет/webhook URL). Вынесено из integrationSuite ради лимита размера файла.
 */
...
export async function runIntegrationE2eChecks(
  ctx: app.Ctx,
