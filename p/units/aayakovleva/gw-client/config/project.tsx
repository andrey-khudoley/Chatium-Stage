...
export const DEFAULT_PROJECT_TITLE = 'Payments Client'
...
export const BODY_TEXT = 'Payments Client'

/** Подзаголовок домашней страницы */
export const BODY_SUBTEXT =
  'Универсальный клиент платёжных гейтвеев: журналы запросов и webhook, аналитика, создание счётов'
