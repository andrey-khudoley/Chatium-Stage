...
import { ORDER_T2_PAGE_TITLE, getPageTitle } from '../../config/project'
import * as settingsLib from '../../lib/settings.lib'

const LOG_PATH = 'web/t2/index'

export const orderT2PageRoute = app.html('/', async (ctx, req) => {
  await loggerLib.writeServerLog(ctx, {
    severity: 7,
    message: `[${LOG_PATH}] Запрос страницы заявки (T2)`,
  ...
  return (
    <html lang="ru">
      <head>
        <title>{getPageTitle(ORDER_T2_PAGE_TITLE, projectName)}</title>
      ...
      <body>
        <OrderTFormPage pageVariant="t2" pageTitle={ORDER_T2_PAGE_TITLE} />
      </body>
    </html>
  )
})

export default orderT2PageRoute
