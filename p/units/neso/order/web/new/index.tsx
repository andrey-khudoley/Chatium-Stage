...
import OrderNewFormPage from '../../pages/OrderNewFormPage.vue'
import {
...
import { NEW_ORDER_PAGE_NAME, getPageTitle } from '../../config/project'
import * as settingsLib from '../../lib/settings.lib'

const LOG_PATH = 'web/new/index'

export const orderNewPageRoute = app.html('/', async (ctx, req) => {
  await loggerLib.writeServerLog(ctx, {
    severity: 7,
    message: `[${LOG_PATH}] Запрос страницы заявки`,
  ...
  return (
    <html lang="ru">
      <head>
        <title>{getPageTitle(NEW_ORDER_PAGE_NAME, projectName)}</title>
...
export default orderNewPageRoute
