  ...
  <div class="slide">
    ...
    <div class="content">
      <div class="header">
        ...
        <p class="subtitle">Загрузите что угодно — <span class="accent">доставим мгновенно</span></p>
      </div>
...
const features = [
  { icon: 'fas fa-image', title: 'Авто-превью', desc: 'Загрузили фото — платформа сама создаёт миниатюры нужных размеров. Ретина, мобайл — всё из коробки.' },
  { icon: 'fas fa-globe', title: 'CDN по всему миру', desc: 'Файлы отдаются с ближайшего сервера. Картинки грузятся за миллисекунды, видео не буферит.' },
  { icon: 'fas fa-file-zipper', title: 'Умная оптимизация', desc: 'Автоматическое сжатие без потери качества. Экономия трафика до 70% для ваших пользователей.' },
]
</script>
...
.orb-1 { width: 550px; height: 550px; background: #14b8a6; top: -20%; right: -10%; }
.orb-2 { width: 400px; height: 400px; background: #2dd4bf; bottom: -15%; left: -5%; animation-delay: -8s; }
...
@media (max-width: 768px) {
  ...
  .subtitle { font-size: 18px; margin-top: 8px; }
