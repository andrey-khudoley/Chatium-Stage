...
const cards = [
  {
    icon: 'fas fa-gavel', title: 'Юридическое', color: '#6366f1',
    items: ['152-ФЗ — данные в российских дата-центрах', '54-ФЗ — автоматические чеки при оплате', 'Нет риска блокировок']
  },
  {
    icon: 'fas fa-credit-card', title: 'Платежи РФ', color: '#10b981',
    items: ['ЮКасса, CloudPayments, Invoice', 'МИР, Visa РФ, MasterCard РФ, СБП', 'Рекуррентные, оплата в 1 клик']
  },
  {
    icon: 'fas fa-plug', title: 'Интеграции', color: '#06b6d4',
...
.num {
  ...
  color: var(--accent-indigo); padding: 6px 14px; border: 1px solid rgba(99,102,241,0.3);
  border-radius: 8px; margin-bottom: 16px;
  background: rgba(99,102,241,0.05);
}
.title { font-family: var(--font-display); font-size: clamp(26px, 4vw, 42px); font-weight: 800; line-height: 1.2; }
...
@media (max-width: 480px) {
  ...
  .card-icon { width: 44px; height: 44px; font-size: 18px; margin-bottom: 14px; border-radius: 12px; }
  .card h3 { font-size: 16px; margin-bottom: 14px; }
  .card li { font-size: 13px; gap: 8px; }
