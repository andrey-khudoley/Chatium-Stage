...
## Назначение
**Flow** (`p/units/k/flow`) — приложение Chatium для задач, учёта времени, проектов, клиентов и финансов (бизнес-ассистент). Текущая кодовая база унаследована от шаблона: главная, админка, профиль, логин, тесты и инфраструктура логов/настроек.
