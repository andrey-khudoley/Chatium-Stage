...
export const DEFAULT_PROJECT_TITLE = 'Flow'
...
export const BODY_TEXT = 'Бизнес-ассистент'

/** Подзаголовок домашней страницы */
export const BODY_SUBTEXT = 'Задачи, время, проекты, клиенты и финансы — в одном месте'
