---
name: "source-command-toprod"
description: "Копирует ассистента (k/assistant) из dev-workspace s.chtm.khudoley.pro в prod-workspace p.chtm.khudoley.pro."
---

# source-command-toprod

Use this skill when the user asks to run the migrated source command `/toprod`.

## Codex Adaptation

- Source of truth: `.claude/commands/toprod.md`.
