...
export declare type HsOfHqExpr<TB extends hs.HsProperties, E extends HqExpr<TB, hs.HeapSchema>> = E extends keyof TB
  ...
  ? hs.HsBoolean
  : E extends HqExprFnNow | HqExprFnDateTrunc<TB>
  ? hs.HsDateTime
...
export declare type HqExprDyn<O extends hs.HeapSchema> = {
  $dyn:
    ...
    | (O extends hs.HsString<infer S> ? S : never)
...
export declare type HqExprFn<TB extends hs.HsProperties, O extends hs.HeapSchema> =
  ...
  | (hs.HsDateTime extends O ? HqExprFnDateTrunc<TB> | HqExprFnNow | HqExprFnCoalesce<TB> : never)
...
export declare type HqExprFnDateTrunc<TB extends hs.HsProperties> = {
  $date_trunc: [HqExprDyn<hs.HsString<PgDateField>>, HqExpr<TB, hs.HsDateTime>, HqExprDyn<hs.HsString>]
}
...
export declare type PgDateField =
  | 'microseconds'
  | 'milliseconds'
  | 'second'
  | 'minute'
