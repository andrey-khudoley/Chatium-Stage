...
export interface UgcAccountFull
  extends RichUgcAccount,
    Pick<UgcChildAccount, 'title' | 'image' | 'lang' | 'createdAt' | 'ownerUserIds'> {}
export declare function getAccountById(ctx: RichUgcCtx, id: number): Promise<UgcAccountFull>
export declare function listAllChildAccounts(ctx: RichUgcCtx): Promise<UgcAccountFull[]>
