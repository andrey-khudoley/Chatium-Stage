...
interface AccountBalanceTransaction {
  ...
  net_cost_rub: string | null
}
interface AccountBalanceTransactionRich extends AccountBalanceTransaction {
  app_slug: string | null
}
interface DebitBalanceTokenResultUgc {
  balance: CurrentAccountBalanceTokenResult
  transactions: DebitBalanceTransactionUgc[]
}
interface DebitBalanceTransactionUgc {
  balance_type: BalanceTypeUgc
  balance_change: string
  created_at: Date
}
declare type BalanceTypeUgc = 'regular' | 'free' | 'burnable' | 'referral'
 ...
 */
export declare function installApp(_ctx: RichUgcCtx, appSlug: string): Promise<void>
/**
...
export declare function debitBalanceTokenRegular(
  _ctx: RichUgcCtx,
  amount: string | number,
  message: string,
  data: any,
...
): Promise<DebitBalanceTokenResultUgc>
export declare function creditBalanceTokenReferral(
  _ctx: RichUgcCtx,
  amount: string | number,
  message: string,
  data: any,
...
export declare function creditBalanceTokenFree(
  _ctx: RichUgcCtx,
  amount: string | number,
  message: string,
  data: any,
...
export declare function transferBalanceTokens(
  _ctx: RichUgcCtx,
  from: BalanceTypeUgc,
  to: BalanceTypeUgc,
  amount: string,
