...
declare type AccountBoundAppHostTablesHook = (ctx: RichUgcCtx) => PlainOrPromise<AccountBoundAppHostTablesHookResult>
declare type AccountBoundAppHostTablesHookResult = Array<[tableName: string, accountIdFieldName: string]>
...
declare function registerUgcHook(hookName: 'account-bound-app-host-tables', value: AccountBoundAppHostTablesHook): void
...
interface ChatiumRc {
  ...
  headExtra?: string[]
  bodyExtra?: string[]
  indexPath?: string | Record<string, string>
  ...
  signInConsent?: SignInConsent[]
  /** URL for the policy link in sign-in consent text (used with <p>...</p> tags) */
  signInPolicyUrl?: string | null
  globalJsx?: 'app/ui' | false
}
declare type SignInConsent = {
  title: string
  policyUrl?: string
  ...
  constructor(
    logFn?:
      | import('isolated-vm').Reference<
          (level: 'log' | 'debug' | 'error' | 'warn' | 'info', ...args: unknown[]) => void
        >
      | undefined,
  )
