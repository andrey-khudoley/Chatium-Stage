      ...
      <div class="container mx-auto px-4 py-4">
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-3">
            ...
            <div>
              <h1 class="text-2xl font-bold text-dark">Unit Tests - Storage</h1>
                ...
                <div class="flex items-start justify-between">
                  <div class="flex-1">
                    ...
                    <div v-if="test.status === 'failed'" class="space-y-2">
                      ...
                      <div v-if="test.details" class="text-xs bg-red-100 p-2 rounded font-mono text-red-800 whitespace-pre-wrap max-h-40 overflow-y-auto">
                        {{ test.details }}
                      </div>
                    </div>
                  </div>
