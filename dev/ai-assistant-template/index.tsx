  ...
  return (
    <html>
      <head>
        ...
        <meta charset="UTF-8" />
        <meta name="description" content="Интеллектуальный AI ассистент для помощи в решении задач" />
        ...
        <script>{`
          document.addEventListener('DOMContentLoaded', function() {
            // Показываем прелоадер минимум 500мс
            setTimeout(function() {
      ...
      <body>
        ...
        <div id="preloader" class="preloader">
          <div class="flex flex-col items-center">
            ...
            <p class="preloader-text mt-4">Загрузка...</p>
          </div>
        </div>
