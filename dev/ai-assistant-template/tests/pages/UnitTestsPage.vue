      ...
      <div class="container mx-auto px-4 py-4">
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-3">
            ...
            <div>
              <h1 class="text-2xl font-bold text-dark">Unit Tests - AI Ассистент</h1>
              <p class="text-sm text-gray-600">Комплексное тестирование функционала чата</p>
            </div>
          </div>
    ...
    <div class="container mx-auto px-4 py-6">
      <div class="max-w-6xl mx-auto space-y-6">
        ...
        >
          ...
          <!-- Тесты категории -->
          <div v-show="expandedCategories[category.name]" class="p-6 space-y-3">
            <div 
