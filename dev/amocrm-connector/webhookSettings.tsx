...
import WebhookSettingsPage from './pages/WebhookSettingsPage.vue'
import { tailwindScript, cssVariables, commonStyles, preloaderStyles, loaderScript } from './styles'

export const webhookSettingsPageRoute = app.get('/webhookSettings', async (ctx) => {
  return (
    <html>
      <head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Настройки вебхуков - AmoCRM Connector</title>
