...
import PaymentServicePage from './pages/PaymentServicePage.vue'
import { tailwindScript, cssVariables, commonStyles, preloaderStyles, loaderScript } from './styles'

// Импортируем API роуты для регистрации
import './api/paymentService'

export const paymentServicePageRoute = app.get('/', async (ctx) => {
  return (
    <html>
      <head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Генерация ссылок на оплату - AmoCRM Connector</title>
