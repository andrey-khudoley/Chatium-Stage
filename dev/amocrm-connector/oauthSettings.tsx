...
import OAuthSettingsPage from './pages/OAuthSettingsPage.vue'
import { tailwindScript, cssVariables, commonStyles, preloaderStyles, loaderScript } from './styles'

export const oauthSettingsPageRoute = app.get('/', async (ctx) => {
  ...
  return (
    <html>
      <head>
        ...
        <title>Настройки OAuth - AmoCRM Connector</title>
