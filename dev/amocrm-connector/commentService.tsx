...
import CommentServicePage from './pages/CommentServicePage.vue'
...
export const commentServicePageRoute = app.get('/', async (ctx) => {
  return (
    <html>
      <head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Комментарии в AmoCRM - AmoCRM Connector</title>
