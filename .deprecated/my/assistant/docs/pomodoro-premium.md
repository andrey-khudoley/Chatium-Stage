...
```css
--color-bg: #0a0a0a --color-bg-secondary: #141414 --color-bg-tertiary: #1a1a1a --color-text: #e8e8e8
  --color-text-secondary: #a0a0a0 --color-border: #2a2a2a --color-border-light: #3a3a3a
  --color-accent: #d3234b;
```
